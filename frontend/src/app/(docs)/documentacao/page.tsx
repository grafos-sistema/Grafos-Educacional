...
const legacySections: DocSection[] = [
  {
    id: "inicio",
    group: "Comece aqui",
    title: "Introdução",
    summary:
      "Um guia prático para usar a plataforma Grafos com segurança e na sequência correta.",
    toc: [
    ...
    content: (
      <>
        <p>
          Esta documentação explica o uso do Grafos em linguagem simples.
          Escolha um assunto no menu para ver a sequência de trabalho, os
          responsáveis por cada etapa e o que pode ou não ser alterado.
        </p>
        <h2 id="quem-usa">Quem usa o sistema?</h2>
        <p>
          A direção acompanha e autoriza processos, a coordenação organiza o
          trabalho pedagógico, o professor registra o dia a dia escolar e a
          secretaria mantém os cadastros e dados da instituição.
        </p>
        <h2 id="como-navegar">Como navegar nesta documentação</h2>
        <p>
          Comece pela estrutura da instituição. Depois, siga para cadastros,
          disciplinas, turmas, grade de horários, frequência e avaliações. Essa
          ordem evita que listas apareçam vazias ou que um vínculo seja criado
          no lugar errado.
        </p>
        <h2 id="regra-geral">Regra geral de permissões</h2>
        <div className="docs-callout">
          <strong>Importante:</strong> visualizar uma informação não significa
          que o perfil pode alterá-la. A documentação e o sistema exibem somente
          as ações permitidas para cada usuário.
        </div>
      </>
    ),
  },
  {
    ...
    summary:
      "A ordem recomendada para estruturar uma escola antes do início das aulas.",
    toc: [
    ...
    content: (
      <>
        <p>
          Antes de lançar notas ou frequência, a instituição precisa ter sua
        ...
        <ol>
          ...
          <li>
            Cadastre os usuários e vincule cada pessoa à instituição correta.
          </li>
          <li>
            Vincule as disciplinas às turmas e os professores às disciplinas.
          </li>
          <li>Monte a grade de horários.</li>
        </ol>
        <h2 id="por-que-ordem">Por que seguir esta ordem?</h2>
        <p>
          Cada etapa usa os vínculos criados na anterior. Por exemplo: uma
          disciplina precisa existir para ser associada a uma turma; a turma e a
          disciplina precisam estar vinculadas antes de montar a grade; e a
          grade é usada para permitir o lançamento da frequência.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Cada bimestre possui quatro espaços de avaliação: VA1, VA2, VA3 e VA4.
          O professor pode usar somente as verificações de aprendizagem que
          realmente aplicou.
        </p>
        ...
        <ul>
          ...
          <li>
            A média do bimestre considera somente as VAs que foram preenchidas.
          </li>
          <li>
            Atividades, trabalhos e provas podem compor pedagogicamente uma VA,
            mas o sistema recebe a nota consolidada daquela VA.
          </li>
        </ul>
...
Média do bimestre = (7 + 8) / 2 = 7,5`}</code>
        </pre>
        <h2 id="fluxo-notas">Fluxo recomendado</h2>
        <ol>
          <li>
            Direção ou coordenação cria e libera a avaliação para a turma,
            disciplina, bimestre e VA.
          </li>
          <li>
            O professor abre <strong>Lançar Notas</strong> e seleciona a turma,
            a disciplina e o período.
          </li>
          <li>
            O professor informa as notas dos alunos nas VAs disponíveis e salva.
          </li>
          <li>
            A equipe responsável revisa e publica o resultado para a família.
          </li>
        </ol>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          Uma avaliação é o registro oficial de uma VA. Ela identifica a turma,
          a disciplina, o bimestre e a verificação de aprendizagem que receberá
          notas. Atividades, trabalhos, projetos e questões apoiam o
          planejamento pedagógico, mas não adicionam pontos extras
          automaticamente.
        </p>
        <h2 id="quem-faz">Quem pode fazer o quê?</h2>
        <ul>
          <li>
            <strong>Direção e coordenação:</strong> cadastram, aprovam e liberam
            avaliações.
          </li>
          <li>
            <strong>Professor:</strong> lança as notas e pode propor uma
            avaliação para aprovação.
          </li>
          <li>
            <strong>Proposta do professor:</strong> fica aguardando aprovação
            antes de poder ser usada no lançamento de notas.
          </li>
          <li>
            <strong>Secretaria:</strong> apoia cadastros e informações
            administrativas conforme a permissão recebida.
          </li>
        </ul>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          O professor registra frequência somente nas aulas previstas na grade
          para aquela turma, disciplina e data. O calendário mostra os dias com
          aula.
        </p>
        ...
        <div className="docs-callout">
          <strong>Atenção:</strong> se for necessário lançar uma aula em outro
          dia, a direção ou a coordenação deve autorizar a exceção. Isso mantém
          o histórico da turma coerente com a grade oficial.
        </div>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          Ao importar alunos ou professores, selecione primeiro a instituição e
          o anexo que receberá os cadastros. A planilha não precisa repetir a
          escola quando ela já foi escolhida na tela de importação.
        </p>
        <p>
          Use sempre o modelo baixado no próprio menu e mantenha os nomes das
          colunas. Linhas inválidas aparecem separadas com uma explicação
          amigável; os registros válidos continuam sendo importados.
        </p>
        <h2 id="vinculos">Vínculos após o cadastro</h2>
        <p>
          Depois do cadastro, confirme os vínculos necessários: aluno com turma,
          professor com disciplina e disciplina com turma. O cadastro da pessoa,
          sozinho, não cria esses vínculos automaticamente.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li>
            <strong>Super Admin Global:</strong> administra a plataforma e
            consulta as instituições.
          </li>
          <li>
            <strong>Diretor:</strong> administra a instituição, aprova processos
            e acompanha resultados.
          </li>
          <li>
            <strong>Coordenador:</strong> organiza disciplinas, turmas,
            avaliações e o acompanhamento pedagógico.
          </li>
          <li>
            <strong>Professor:</strong> trabalha com suas turmas, registra
            frequência, notas e atividades autorizadas.
          </li>
          <li>
            <strong>Secretaria:</strong> mantém cadastros e informações
            administrativas conforme a permissão recebida.
          </li>
        </ul>
        <h2 id="consulta-edicao">Consulta e edição</h2>
        <p>
          O sistema separa o que pode ser consultado do que pode ser alterado.
          Quando um botão de edição não aparece, a ação está reservada a outro
          perfil responsável por aquela etapa.
        </p>
      </>
    ),
  },
...
// Keep the original compact content as a safe fallback while the full
// step-by-step guide is the canonical documentation shown to users.
const sections: DocSection[] = documentationSections.length
...
export default function DocumentationPage() {
  ...
  const filtered = useMemo(() => {
    ...
    return sections.filter((section) =>
      `${section.group} ${section.title} ${section.summary}`
  ...
  return (
    <div className="min-h-screen bg-[#090c0d] text-[#e8ebed]">
      ...
      <div className="sticky top-14 z-20 border-b border-white/10 bg-[#1f6534]">
        <div className="mx-auto flex h-9 max-w-[1560px] items-center gap-3 px-4 sm:px-7">
          ...
          <div className="relative ml-auto hidden w-64 sm:block">
            ...
            />
            <kbd className="absolute right-2 top-1/2 -translate-y-1/2 text-[9px] font-semibold text-white/60">
              CTRL K
            </kbd>
          </div>
        </div>
      ...
      <div className="mx-auto flex max-w-[1560px]">
        ...
        <aside
          className={`${mobileMenu ? "fixed inset-y-0 left-0 z-30 block w-[290px] pt-14 shadow-2xl" : "hidden"} shrink-0 border-r border-white/10 bg-[#0d1011] lg:sticky lg:top-[92px] lg:block lg:h-[calc(100vh-92px)] lg:w-[290px] lg:overflow-y-auto`}
        >
          ...
          <nav className="p-4">
            <div className="mb-7 flex h-8 items-center justify-between rounded-[5px] border border-white/15 px-2 text-[10px] font-bold uppercase tracking-wide text-slate-400">
              <span>Ir para</span>
              <kbd className="rounded border border-white/15 px-1 text-[9px] text-slate-500">
                Ctrl K
              </kbd>
            </div>
            {Array.from(new Set(filtered.map((section) => section.group))).map(
              (group) => (
        ...
        <main className="min-w-0 flex-1 px-5 pb-16 pt-8 sm:px-8 lg:px-12 lg:pt-10 xl:px-16">
          <div className="mx-auto max-w-[780px]">
            ...
            <p className="mb-6 text-[15px] leading-7 text-slate-300">
              {active.summary}
            </p>
            <article className="docs-article text-[14px] leading-[1.65] text-slate-200">
              {active.content}
            </article>
      ...
      <style jsx>{`
        ...
        .docs-article :global(.docs-table-wrap) {
        ...
        .docs-article :global(td:first-child) {
          color: #ffffff;
          font-weight: 600;
          white-space: nowrap;
        }
        .docs-article :global(.docs-result) {
          color: #c7f0d1;
        }
        ...
        .docs-article :global(.docs-callout) {
          margin: 1.25rem 0;
          border-left: 2px solid #33a551;
          background: rgba(51, 165, 81, 0.1);
          padding: 0.9rem 1rem;
          color: #d7f6df;
        }
        .docs-article :global(.docs-code) {
          margin: 1.15rem 0;
          overflow-x: auto;
          border: 1px solid rgba(255, 255, 255, 0.14);
          border-radius: 5px;
