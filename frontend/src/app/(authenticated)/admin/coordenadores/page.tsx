      ...
      render: (user) => (
        <div className="flex gap-2">
          ...
          <button
            onClick={(e) => {
              e.stopPropagation();
              router.push(`/admin/coordenadores/${user.id}/edit`);
            }}
    ...
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Gerencie os coordenadores pedagógicos da instituição
        </p>
      </div>
        ...
        <div>
          {data && (
            <p className="text-sm text-gray-600 dark:text-gray-400">
              {data.meta.total} coordenador(es) encontrado(s)
            </p>
          )}
        </div>
        <Button
          onClick={() => router.push('/admin/coordenadores/new')}
