...
const FEATURES = [
  {
    ...
    color: "#1d6ff2",
    desc: "Alunos, professores, responsáveis e coordenadores.",
  },
  {
    title: "Acadêmico",
    color: "#12a150",
    desc: "Turmas, disciplinas, horários, anos letivos e calendário escolar.",
  },
  {
    title: "Indicadores",
    color: "#7c3aed",
    desc: "Relatórios, estatísticas e acompanhamento de desempenho.",
  },
  {
    title: "Administração",
    color: "#f97316",
    desc: "Cursos, comunicados, eventos e configurações da instituição.",
  },
];
...
const PERKS = [
  ...
  { title: "Seguro", desc: "Seus dados protegidos com tecnologia avançada." },
  {
    ...
    desc: "Funciona no computador, tablet e celular.",
  },
  {
    title: "Interface moderna",
    desc: "Navegação simples, rápida e intuitiva.",
  },
];
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow:
          "0 3px 6px rgba(0,0,0,.25), inset 0 -3px 4px rgba(0,0,0,.15)",
      }}
    >
      <div
      ...
      >
        ...
        <path
          d="M4.5 21c0-4.2 3.4-6.8 7.5-6.8s7.5 2.6 7.5 6.8"
...
export default function AdminLoginPage() {
  ...
  const fieldBorder = (hasError: boolean, isFocused: boolean) =>
    hasError
      ? "border-red-500"
      : isFocused
        ? "border-[#0e7a3e] ring-[3px] ring-[#0e7a3e]/15"
        : "border-[#d7ddd9]";
      ...
      <div className="relative flex w-full min-w-0 flex-none flex-col justify-start gap-5 overflow-y-auto bg-white px-4 py-6 sm:px-6 sm:py-8 lg:w-[30%] lg:min-w-[380px] lg:justify-center lg:px-14 lg:py-8">
        ...
        <div className="mx-auto mt-2 flex w-full max-w-sm items-center gap-3.5 lg:mx-0 lg:mt-8 lg:max-w-none">
          ...
          <div className="flex flex-col gap-0.5">
            <div className="text-[27px] font-extrabold text-[#0e7a3e] leading-none">
              Grafos
            </div>
        ...
        <form
          ...
          className="mx-auto flex w-full max-w-sm flex-col gap-4 lg:mx-0 lg:max-w-none"
        >
          {error && (
          ...
          <div className="rounded-lg border border-[#d7ddd9] bg-[#f5faf7] px-4 py-3">
            <p className="text-[13.5px] font-bold text-[#1f2a24]">
              Primeiro acesso?
            </p>
          ...
          <div className="flex items-center justify-between -mt-0.5">
            <label className="flex items-center gap-2 cursor-pointer text-[13.5px] text-[#3d4642]">
              <input
                type="checkbox"
                {...register("remember")}
                className="w-4 h-4 accent-[#0e7a3e]"
              />
              Lembrar-me
            </label>
            <Link
              href="/forgot-password"
              className="text-[13.5px] font-bold text-[#0e7a3e] underline"
            >
              Esqueceu sua senha?
            </Link>
          </div>
      ...
      <div className="flex-1 bg-[#01603c] flex flex-col px-14 pt-6 box-border text-white relative overflow-hidden hidden lg:flex">
        <div className="flex items-start gap-[26px]">
          ...
          >
            ...
            <path
              d="M12 8 L17.5 10.2 L12 12.4 L6.5 10.2 Z"
              fill="#fff"
              stroke="none"
            />
            <path
              d="M8.5 11.2 v2.6 c0 1.1 1.6 2 3.5 2 s3.5 -.9 3.5 -2 v-2.6"
              fill="none"
            />
          </svg>
          <div className="flex flex-col gap-1.5">
            <div className="text-[38px] 2xl:text-[42px] font-extrabold leading-[1.05] tracking-tight">
              Gestão Escolar Inteligente
            </div>
            <div className="text-xl leading-[1.4] text-white/90">
              Gerencie alunos, professores, turmas, disciplinas
              <br />e toda a rotina escolar em uma{" "}
              <span className="text-[#5fd98a] font-semibold">
                única plataforma
              </span>
              .
            </div>
        ...
        <div className="grid grid-cols-4 gap-4 mt-5">
          {FEATURES.map((f) => (
            <div
              key={f.title}
              className="bg-white/[.08] border border-white/[.12] rounded-[14px] p-[18px] flex flex-col gap-2.5"
            >
              <div
              ...
              <div className="text-[14.5px] leading-[1.45] text-white/85 -mt-1.5">
                {f.desc}
              </div>
            </div>
          ))}
        ...
        <div className="flex mt-4 border-t border-white/[.18] pt-4">
          {PERKS.map((p, i) => (
            <div
              key={p.title}
              className={`flex-1 flex gap-3 items-start px-[18px] ${i > 0 ? "border-l border-white/[.18]" : ""}`}
            >
              <div className="flex flex-col gap-0.5">
                <div className="text-[15.5px] font-bold">{p.title}</div>
                <div className="text-[13px] leading-[1.4] text-white/85">
                  {p.desc}
                </div>
              </div>
            </div>
            ...
            <div className="absolute inset-0">
              ...
              <div className="absolute left-[3.7%] top-[8%] w-[20.5%] bg-white rounded-xl shadow-[0_10px_22px_rgba(0,0,0,.28)] p-3 flex flex-col gap-1.5 box-border">
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-[12.5px] font-bold whitespace-nowrap text-gray-900">
                    Calendário Letivo
                  </div>
                </div>
                <div className="grid grid-cols-7 gap-0.5">
                  {["D", "S", "T", "Q", "Q", "S", "S"].map((w, i) => (
                    <div
                      key={i}
                      className="text-[7.5px] font-bold text-center text-[#9aa39d]"
                    >
                      {w}
                    </div>
                  ))}
              ...
              <div className="absolute left-[4.1%] top-[52%] w-[18%] bg-white rounded-xl shadow-[0_10px_22px_rgba(0,0,0,.28)] p-3.5 flex flex-col gap-[11px] box-border">
                ...
                <div className="flex gap-3.5">
                  {STUDENTS.map((s) => (
                    ...
                    >
                      <Avatar3D {...s} />
                      <div className="text-[9px] font-semibold text-[#7b847e]">
                        {s.name}
                      </div>
                    </div>
                  ))}
              ...
              <div className="absolute left-[73.6%] top-[5%] w-[20.5%] bg-white rounded-xl shadow-[0_10px_22px_rgba(0,0,0,.28)] p-3 flex flex-col gap-[7px] box-border">
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-[13.5px] font-bold whitespace-nowrap text-gray-900">
                    Diário de Classe
                  </div>
                </div>
                {DIARY_ROWS.map((r) => (
                  <div key={r.name} className="flex items-center gap-2">
                    <Avatar3D {...r} size={20} />
                    <div className="text-[11.5px] text-[#3d4642] flex-1">
                      {r.name}
                    </div>
                    <svg
                      width="13"
              ...
              <div className="absolute left-[73.6%] top-[47%] w-[20.5%] bg-white rounded-xl shadow-[0_10px_22px_rgba(0,0,0,.28)] p-4 flex flex-col gap-2.5 box-border">
                ...
                <div className="flex flex-col gap-1.5">
                  {[
                    "Reunião de pais — dia 15",
                    "Novo comunicado da direção",
                  ].map((txt) => (
              ...
              <div className="absolute left-[73.6%] top-[76%] w-[15%] bg-white rounded-xl shadow-[0_10px_22px_rgba(0,0,0,.28)] p-4 flex flex-col gap-[11px] box-border">
                ...
                <div className="flex items-center gap-3.5">
                  <div
                    ...
                    style={{
                      background:
                        "conic-gradient(#1d6ff2 0deg 130deg, #f97316 130deg 220deg, #0e9a4e 220deg 360deg)",
                    }}
                  />
