...
const GradCap = ({ size = 26 }: { size?: number }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const Envelope = ({ color = "#94a3b8" }: { color?: string }) => (
  <svg
    width="18"
    height="18"
    viewBox="0 0 24 24"
...
const CARDS = [
  {
    ...
    desc: "Visualize e organize todas as suas disciplinas.",
    color: "#8b5cf6",
    icon: (
      <svg
        width="23"
  ...
  {
    title: "Turmas",
    desc: "Acesse suas turmas e acompanhe seus alunos.",
    color: "#10b981",
    icon: (
      <svg
        width="23"
  ...
  {
    title: "Notas",
    desc: "Registre e acompanhe o desempenho dos alunos.",
    color: "#f59e0b",
    icon: (
      <svg
        width="23"
  ...
  {
    title: "Frequência",
    desc: "Controle de presença de forma prática.",
    color: "#ef4444",
    icon: (
      <svg
        width="23"
  ...
  },
  {
    ...
    desc: "Crie avaliações com questões organizadas.",
    color: "#3b82f6",
    icon: (
      <svg
        width="23"
  ...
  },
  {
    ...
    desc: "Cadastre e consulte seus planos de ensino.",
    color: "#ec4899",
    icon: (
      <svg
        width="23"
  ...
  {
    title: "Atividades",
    desc: "Crie tarefas, trabalhos e avaliações.",
    color: "#14b8a6",
    icon: (
      <svg
        width="23"
    ...
    <>
      ...
      >
        <div
          ref={scRef}
          className="scaler"
          style={{ transformOrigin: "top left", width: 1536, height: 1024 }}
        >
          <div
          ...
          >
            ...
            <aside
              className="sidebar fade-in flex-none w-[30%] min-w-[380px] bg-white flex flex-col justify-center gap-5 px-14 py-8 box-border relative overflow-y-auto z-20"
              style={{}}
            >
              <Link
                href="/"
              ...
              <div className="mt-8 flex items-center gap-3.5">
                <img
                  src="/assets/logo_grafos2.png"
                  alt="Logo Grafos"
                  style={{ width: 54, height: 58, objectFit: "contain" }}
                />
                <div className="flex flex-col gap-0.5">
                  <div className="text-[27px] font-extrabold text-[#1565d8] leading-none m-0">
                    Grafos
                  </div>
                  <div className="text-base text-[#5b6560] m-0">
                    Gestão Escolar
                  </div>
                </div>
              </div>
              ...
              >
                {error && (
                  <div className="rounded-lg bg-red-50 border border-red-200 p-3">
                    <p className="text-sm text-red-700 font-medium m-0">
                      {error}
                    </p>
                  </div>
                )}
                ...
                <label className="flex flex-col gap-2 m-0">
                  ...
                  {errors.email && (
                    <span className="text-[12.5px] font-semibold text-red-600 m-0">
                ...
                <div className="rounded-lg border border-[#d2dfef] bg-[#eff4fb] px-4 py-3">
                  <p className="text-[13.5px] font-bold text-slate-900 m-0">
                    Primeiro acesso?
                  </p>
                  <p className="mt-1 text-[12.5px] text-[#5f6a64] m-0">
                    A senha inicial é formada pelos 6 primeiros dígitos do CPF.
                    No primeiro acesso, o usuário deverá criar uma nova senha.
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between -mt-0.5">
                  ...
                  <Link
                    ...
                    className="text-[13.5px] font-bold text-[#1565d8] underline m-0"
              ...
              <div className="flex gap-4 bg-[#eff4fb] border border-[#d2dfef] rounded-[10px] px-[22px] py-5 mt-1.5">
                ...
                <div className="flex flex-col gap-1">
                  <div className="text-[14.5px] font-bold m-0 text-slate-900">
                    Precisa de ajuda para acessar?
                  </div>
                  <div className="text-[13px] text-[#6a736e] m-0">
            ...
            {/* ================= PAINEL DIREITO (AZUL) ================= */}
            <main
              className="main-panel fade-in-delayed"
              style={{
                position: "relative",
                flex: 1,
                minWidth: 920,
                height: "100%",
                background:
                  "linear-gradient(100deg, #0464de 0%, #0562d5 45%, #0180bb 100%)",
                overflow: "hidden",
              }}
            >
              ...
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                style={{ position: "absolute", top: 80, right: 330 }}
              >
                <path d="M4 19.5A2.5 2.5 0 016.5 17H20" />
                <path d="M6.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15A2.5 2.5 0 016.5 2z" />
              </svg>
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                style={{ position: "absolute", top: 70, right: 170 }}
              >
                <path d="M22 10v6M2 10l10-5 10 5-10 5z" />
                <path d="M6 12v5c3 3 9 3 12 0v-5" />
              </svg>
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                style={{ position: "absolute", top: 130, right: 60 }}
              >
                <rect x="3" y="4" width="18" height="18" rx="2" />
                <path d="M16 2v4M8 2v4M3 10h18" />
              </svg>
                ...
                <>
                  <div
                    style={{
                      ...
                      bottom: 0,
                      WebkitMaskImage:
                        "linear-gradient(to right, transparent 0px, #000 110px)",
                      maskImage:
                        "linear-gradient(to right, transparent 0px, #000 110px)",
                    }}
                  >
                    <img
                      src="/assets/fundo_prof3.png"
                      alt=""
                      style={{
                        width: 1096,
                        height: "auto",
                  ...
                  <img
                    src="/assets/professor_strip.png"
                    alt=""
                    aria-hidden="true"
                    style={{
                      position: "absolute",
                      ...
                      display: "block",
                      WebkitMaskImage:
                        "linear-gradient(to right, transparent 0px, #000 130px), linear-gradient(to bottom, transparent 0px, #000 90px)",
              ...
              {/* Faixa de benefícios */}
              <div
                className="benefits-strip fade-in-up"
                style={{
                  position: "absolute",
                  left: 40,
                  right: 40,
              ...
              >
                {[
                  {
                    title: "Acesso Online",
                    desc: "Acesse de qualquer lugar e dispositivo.",
                    icon: (
                      <svg
                        width="19"
                        height="19"
                  ...
                  {
                    title: "Sincronização",
                    desc: "Seus dados são salvos automaticamente.",
                    icon: (
                      <svg
                        width="19"
                        height="19"
                  ...
                  {
                    title: "Segurança",
                    desc: "Ambiente seguro e dados protegidos.",
                    icon: (
                      <svg
                        width="19"
                        height="19"
                  ...
                  },
                  {
                    ...
                    desc: "Design moderno, simples e fácil de usar.",
                    icon: (
                      <svg
                        width="19"
                        height="19"
                  ...
                  {
                    title: "Produtividade",
                    desc: "Mais organização e tempo para o que importa.",
                    icon: (
                      <svg
                        width="19"
                        height="19"
              ...
              >
                ...
                >
                  <path
                    d="M24 2L2 12l22 10 22-10L24 2z"
                    stroke="rgba(255,255,255,.85)"
                    strokeWidth="2"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M12 17v10c0 3 5.4 6 12 6s12-3 12-6V17"
                    stroke="rgba(255,255,255,.85)"
                    strokeWidth="2"
                    strokeLinecap="round"
                  />
                ...
                <div>
                  ...
                  >
                    Organize suas aulas, registre notas, acompanhe frequência
                    <br />e mantenha a comunicação com seus alunos.
                  </p>
                </div>
              </div>
