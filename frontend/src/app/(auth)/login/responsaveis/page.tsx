    ...
    <div className="w-screen h-screen flex font-[system-ui] bg-white overflow-hidden">
      ...
      <div className="flex-none w-full lg:w-[30%] lg:min-w-[380px] bg-white flex flex-col justify-center gap-5 px-8 lg:px-14 py-8 box-border relative overflow-y-auto z-20">
        ...
        <div className="mt-8 flex items-center gap-3.5">
          ...
          <div className="flex flex-col gap-0.5">
            <div className="text-[27px] font-extrabold text-[#ea580c] leading-none">
              Grafos
            </div>
        ...
        >
          ...
          <div className="flex items-center justify-between -mt-0.5">
            ...
            <Link
              href="#"
              className="text-[13.5px] font-bold text-[#ea580c] underline"
            >
              Esqueceu sua senha?
            </Link>
          </div>
      ...
      >
        <svg
          ...
          style={{ position: "absolute", top: "56px", right: "260px" }}
        >
        ...
        <svg
          ...
          strokeWidth="1.5"
          style={{ position: "absolute", top: "52px", right: "190px" }}
        >
        ...
        <svg
          ...
          stroke="rgba(255,255,255,.13)"
          strokeWidth="1.5"
          style={{ position: "absolute", top: "110px", right: "60px" }}
        >
        ...
        <svg
          ...
          stroke="rgba(255,255,255,.13)"
          strokeWidth="1.5"
          style={{ position: "absolute", top: "190px", right: "150px" }}
        >
          <path d="M3 3v18h18"></path>
          <path d="M7 15v3M12 10v8M17 6v12"></path>
        </svg>
        <svg
          width="26"
          height="26"
          ...
          stroke="rgba(255,255,255,.13)"
          strokeWidth="1.5"
          style={{ position: "absolute", top: "230px", right: "40px" }}
        >
          ...
          >
            ...
            >
              ...
              >
                ...
                <path d="M22 21a4 4 0 00-3-3.87M2 21a4 4 0 013-3.87M16 3.13a4 4 0 010 7.75M8 3.13a4 4 0 000 7.75"></path>
              </svg>
            </div>
            <div>
              <h1
              ...
              >
                Tenha acesso às notas, frequência, agenda escolar, comunicados e
                desenvolvimento acadêmico em um único lugar.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          <div
            style={{
              ...
              borderRadius: "13px",
              padding: "14px 12px",
              boxShadow: "0 12px 24px -10px rgba(60,20,0,.30)",
              minHeight: "112px",
          ...
          >
            ...
            >
              Acompanhe notas, médias e evolução.
            </p>
          </div>
          <div
            style={{
          ...
          >
            ...
            >
              Visualize presenças e faltas do seu filho.
            </p>
          </div>
          <div
            style={{
          ...
          >
            ...
            >
              Receba avisos importantes da escola.
            </p>
          </div>
          <div
            style={{
          ...
          >
            ...
            >
              Consulte tarefas, trabalhos e datas de entrega.
            </p>
          </div>
          <div
            style={{
          ...
          >
            ...
            >
              Confira eventos, reuniões e calendário de provas.
            </p>
          </div>
        </div>

        <img
          src="/assets/familia_cena.png"
          alt="Família acompanhando o portal escolar"
          style={{
            position: "absolute",
            left: "295px",
            bottom: "104px",
            ...
            zIndex: 5,
            WebkitMaskImage:
              "linear-gradient(to bottom, transparent 0px, #000 40px, #000 calc(100% - 8px), transparent 100%), linear-gradient(to right, transparent 0px, #000 90px, #000 calc(100% - 60px), transparent 100%)",
        ...
        >
          <div
            style={{
              ...
              borderRadius: "14px",
              padding: "16px 18px",
              boxShadow: "0 14px 30px -12px rgba(60,20,0,.35)",
            }}
          >
            <div
              style={{
            ...
            <p
              style={{ fontSize: "11px", color: "#94a3b8", margin: "0 0 10px" }}
            >
              Médias do 2º Bimestre
            </p>
            <div
              style={{
                display: "flex",
            ...
            >
              ...
              >
                <span style={{ color: "#475569" }}>Matemática</span>
                <span style={{ fontWeight: 700, color: "#16a34a" }}>9,4</span>
              </div>
              <div
                style={{
                  display: "flex",
              ...
              >
                <span style={{ color: "#475569" }}>Português</span>
                <span style={{ fontWeight: 700, color: "#16a34a" }}>8,9</span>
              </div>
              <div
                style={{
                  display: "flex",
              ...
              >
                <span style={{ color: "#475569" }}>História</span>
                <span style={{ fontWeight: 700, color: "#16a34a" }}>9,1</span>
              </div>
              <div
                style={{
                  display: "flex",
              ...
              >
                <span style={{ color: "#475569" }}>Ciências</span>
                <span style={{ fontWeight: 700, color: "#16a34a" }}>9,0</span>
              </div>
              <div
                style={{
                  display: "flex",
              ...
              >
                <span style={{ color: "#475569" }}>Inglês</span>
                <span style={{ fontWeight: 700, color: "#16a34a" }}>8,7</span>
              </div>
            </div>
            <div
              style={{
            ...
            >
              ...
              >
                ...
                >
                  15
                  <br />
                  <span style={{ fontSize: "8px", fontWeight: 600 }}>AGO</span>
                </div>
                <div>
                  <div
                    style={{
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                Fortaleça o vínculo entre família e escola.
              </p>
            </div>
          </div>
          <div
          ...
          >
            ...
            >
              <svg
                ...
                strokeLinejoin="round"
              >
                <path d="M22 16.92v3a2 2 0 01-2.18 2 19.8 19.8 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.8 19.8 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72c.13 1 .36 1.94.68 2.85a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.23-1.25a2 2 0 012.11-.45c.91.32 1.85.55 2.85.68A2 2 0 0122 16.92z"></path>
              </svg>
            </div>
            <div>
              <h4
              ...
              >
                Acompanhe de qualquer lugar e dispositivo.
              </p>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div>
              ...
              >
                Fale com professores e coordenação.
              </p>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div>
              ...
              >
                Dados sempre atualizados para você acompanhar.
              </p>
            </div>
          </div>
        </div>
