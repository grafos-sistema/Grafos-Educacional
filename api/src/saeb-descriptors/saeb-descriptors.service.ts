  ...
  async seedPortugues5ano() {
    const descriptors = [
      ...
      },
      {
        ...
        skill: 'Relações entre Recursos Expressivos',
        description:
          'Identificar efeitos de sentido decorrentes do uso de pontuação',
        gradeLevel: '5º ano',
      },
      {
        code: 'D14',
        ...
        skill: 'Relações entre Recursos Expressivos',
        description:
          'Identificar o efeito de sentido decorrente do uso de recursos gráficos',
        gradeLevel: '5º ano',
      },
      {
        code: 'D16',
        ...
        description:
          'Identificar marcas linguísticas que evidenciam o locutor e o interlocutor',
        gradeLevel: '5º ano',
      },
    ];
  ...
  async seedMatematica5ano() {
    const descriptors = [
      ...
      },
      {
        ...
        skill: 'Espaço e Forma',
        description:
          'Identificar propriedades comuns e diferenças entre figuras bidimensionais',
        gradeLevel: '5º ano',
      },
      {
        code: 'D4',
      ...
      },
      {
        ...
        skill: 'Números e Operações',
        description:
          'Identificar fração como representação da relação parte/todo',
        gradeLevel: '5º ano',
      },
      {
        code: 'D25',
        ...
        skill: 'Números e Operações',
        description:
          'Resolver problema com números racionais expressos na forma fracionária',
        gradeLevel: '5º ano',
      },
      {
        code: 'D27',
  ...
  async seedPortugues9ano() {
    const descriptors = [
      ...
      },
      {
        ...
        skill: 'Relações entre Textos',
        description:
          'Reconhecer relações entre partes de um texto, identificando repetições ou substituições',
        gradeLevel: '9º ano',
      },
      {
        code: 'D7',
      ...
      },
      {
        ...
        skill: 'Coerência e Coesão',
        description:
          'Estabelecer relações lógico-discursivas presentes no texto, marcadas por elementos de coesão',
        gradeLevel: '9º ano',
      },
      {
        code: 'D12',
      ...
      },
      {
        ...
        skill: 'Relações entre Recursos Expressivos',
        description:
          'Identificar efeitos de sentido decorrentes do uso de pontuação e notações',
        gradeLevel: '9º ano',
      },
      {
        code: 'D14',
        ...
        skill: 'Relações entre Recursos Expressivos',
        description:
          'Identificar o efeito de sentido decorrente da exploração de recursos ortográficos e morfossintáticos',
        gradeLevel: '9º ano',
      },
      {
        code: 'D19',
        ...
        skill: 'Variação Linguística',
        description:
          'Identificar o efeito de sentido decorrente da escolha de palavras ou expressões',
        gradeLevel: '9º ano',
      },
    ];
    ...
    const descriptors = [
      {
        ...
        skill: 'Espaço e Forma',
        description:
          'Identificar a localização e movimentação de objeto em mapas e outras representações gráficas',
        gradeLevel: '9º ano',
      },
      {
        code: 'D2',
      ...
      },
      {
        ...
        skill: 'Espaço e Forma',
        description:
          'Reconhecer a conservação ou modificação de medidas dos lados e do perímetro',
        gradeLevel: '9º ano',
      },
      {
        code: 'D6',
      ...
      },
      {
        ...
        skill: 'Tratamento da Informação',
        description:
          'Associar informações apresentadas em listas e/ou tabelas aos gráficos que as representam',
        gradeLevel: '9º ano',
      },
      {
        code: 'D35',
