...
1. Abra a aplicação pela URL oficial de homologação ou produção autorizada pela equipe ( /security ).
...
7. Abra a instituição e confirme os dados.

Resultado esperado:

&#x20;a instituição foi criada e está disponível para receber anexos e usuários.
...
6. Abra a edição do anexo e confirme os dados.

Resultado esperado:

&#x20;o anexo está salvo e poderá ser selecionado nos cadastros do Diretor, Coordenador, Professor e Aluno.
...
6. Salve.
7. Anote o e-mail e use os 6 primeiros dígitos do CPF como senha inicial.
8. Se desejar testar a foto, adicione-a no cadastro ou posteriormente pelo perfil.

Resultado esperado:

&#x20;o Diretor aparece na listagem e está vinculado à instituição e ao anexo correto.

### 3.4 Testar o primeiro acesso do Diretor

1. Saia da conta do Super Admin Global.
2. Entre com o e-mail do Diretor e os 6 primeiros dígitos do CPF.
...
9. Confirme o ano, as datas e o status.

### 4.2 Criar os períodos acadêmicos

1. Abra o ano letivo criado clicando em "Acessar".
...
&#x20;os períodos ativos poderão ser selecionados no lançamento de notas.
...
9. Abra a visualização para ter um olhar informativo.
...
> Lembrando que são geradas automticamente algumas disciplinas, como Matemática, Língua Portuguesa, Ciências, etc..
...
5. Informe série/ano, Identificação da Turma (A, B, C), turno e capacidade.
6. Marque a turma como ativa.
7. Salve.
8. Confirme que a turma aparece imediatamente na listagem.
9. Abra a edição e verifique as informações preenchidas corretamente.
...
3. Preencha os Dados Pessoais:
   - Nome; Sobrenome;
   - Nome Social; Data de Nascimento; Sexo;
   - CPF;
4. Preencha os Dados de Contato:
   - Email; Celular; Telefone (Opcional);
   - CEP (Busca Automatica e preenchimento automático do endereço); Logradouro; Número;
   - Complemento; Bairro; Cidade; UFS;
5. Selecione a instituição.
6. Escolha uma das opções de abrangência:
   - vincular a um anexo específico; ou
   - indicar que o Coordenador gerencia a instituição inteira e todos os seus anexos.
7. Salve.
8. Teste a validação informando um CPF inválido e confirme que o sistema exibe uma mensagem amigável.
9. Anote o e-mail e use os 6 primeiros dígitos do CPF como senha inicial.
10. Teste o primeiro login e a troca obrigatória de senha.
...
4. Preencha os Dados de Contato:
   ...
   - CEP (Busca Automatica e preenchimento automático do endereço); Logradouro; Número;
   - Complemento; Bairro; Cidade; UFS;
5. Preencha os Dados Profissionais:
   - Formação Principal; Especialização; Registro Profissional (Remover);
   - Data de admissão;
6. Selecione a instituição.
7. Selecione o anexo ou os anexos em que o Professor dará aula.
8. Adicione a foto, se desejar testar o upload.
9. Salve.
10. Confirme que ele aparece na listagem.
11. Teste editar e visualizar o Professor.
12. Confirme que a lista de disciplinas dele é apenas para consulta quando o acesso for de Professor.
...
6. Preencha os dados de Endereço:
   - Cep; Logradouro;
   - Número; Complemento; Bairro; Cidade;
   - UFS;
7. Preencha os dados de Contato:
   - Emaill do Aluno; Celular; Telefone Fixo;
8. Em Responsáveis , clique em Adicionar Responsável e Preencha:
   - Nome completo; Parentesco (_Para parentesco Primo/Prima/Irmão/Irmã, confirme a data de nascimento e a maioridade exigida pelo sistema._);
   - Data de nascimento; CPF; Email;
   - Celular; WhatsApp;

   - Marque, conforme o caso:
     - responsável financeiro;
     - recebe notificações;
     - pode retirar o aluno;
     - contato de emergência.
9. Preencha os dados de Saúde:
   - Tipo sanguíneo;
   - Convênio médico;
   - Alergias;
   - Medicamentos;
...
10. Preencha o Transporte (caso necessário):
...
- Certidão de Nascimento; Identidade do Aluno;
- Histórico Escolar; Carteirinha de Vacinação;
- Atestado Médico para Educação Física; Laudo Médico/Psicopedagógico;

12. Salve o aluno.
13. Reabra a edição e confirme se os dados estão corretos;

14. Abra a visualização do aluno e confirme que o responsável e a turma aparecem.

Se o responsável tiver e-mail e CPF, o sistema poderá criar uma conta para ele usando os 6 primeiros dígitos do CPF como senha inicial. Sem e-mail, ele permanece apenas como registro vinculado ao aluno.
...
6. Salve o arquivo em .CSV ou .XLSX
...
7. Entre com o e-mail do Responsável e os 6 primeiros dígitos do CPF.
...
- [ ] Estruturar visualmente o PDF das questões, atividades e provas.
